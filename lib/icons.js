...
const PATHS = {
  ...
  // Two arcs joined — reads as "brain / deeper model"
  brain:   <><path d="M9 4a3 3 0 00-3 3 2.5 2.5 0 00-1 4.5A2.5 2.5 0 006 16a3 3 0 003 3V4z" /><path d="M15 4a3 3 0 013 3 2.5 2.5 0 011 4.5A2.5 2.5 0 0118 16a3 3 0 01-3 3V4z" /><path d="M12 4v15" /></>,
  // Two opposing arrows in a loop — reads as "swap / change type"
  swap:    <><path d="M4 9h12l-3-3" /><path d="M20 15H8l3 3" /></>,
  // Lightning + sparkle — reads as "regenerate with AI"
  spark:   <><path d="M13 2L5 14h7l-2 8 9-12h-7l2-8z" /><path d="M20 4l.6 1.4L22 6l-1.4.6L20 8l-.6-1.4L18 6l1.4-.6z" /></>,
  // Star — used as "highlight / from-coach" marker
  star:    <path d="M12 2l3 6.5 7 .8-5.2 4.6 1.4 7L12 17.7 5.8 21l1.4-7L2 9.3l7-.8z" />,
  // Pencil — for "edit prescribed workout"
  pencil:  <><path d="M16 3l5 5L8 21H3v-5z" /><path d="M14 5l5 5" /></>,
  // X / trash — for "delete prescribed workout"
  trash:   <><path d="M3 6h18" /><path d="M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2" /><path d="M19 6l-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6" /></>,
  // Boot + heel — reads as "hike / walk"
  hike:    <><path d="M10 4l-1 8h4l3 7H4l1-7h2l1-8z" /><path d="M9 12h6" /></>,
  // Wave lines — reads as "swim"
  swim:    <><path d="M2 12c2-2 4-2 6 0s4 2 6 0 4-2 6 0" /><path d="M2 17c2-2 4-2 6 0s4 2 6 0 4-2 6 0" /><circle cx="17" cy="6" r="2" /></>,
  // Crossed skis + poles — reads as "snow sport"
  ski:     <><path d="M5 21l14-18" /><path d="M19 21L5 3" /><circle cx="6" cy="20" r="1" /><circle cx="18" cy="20" r="1" /></>,
  // Oar shape — reads as "paddle"
  paddle:  <><path d="M12 3v18" /><ellipse cx="12" cy="5" rx="3" ry="3" /><path d="M10 18l4 3" /></>,
  // Mountain peak + flag — reads as "climbing"
  climb:   <><path d="M3 20l6-10 3 4 5-8 4 14z" /><path d="M14 6V3l3 1" /></>,
  // Circular refresh arrow — reads as "sync"
  refresh: <><path d="M3 12a9 9 0 0115-6.7L21 8" /><path d="M21 3v5h-5" /><path d="M21 12a9 9 0 01-15 6.7L3 16" /><path d="M3 21v-5h5" /></>,
  // Kettlebell — handle arc + round body, the universal KB silhouette.
  kettle:  <><path d="M9 8V5a3 3 0 016 0v3" /><path d="M8 8h8" /><circle cx="12" cy="14" r="5.5" /></>,
  // Flexed arm — bent at elbow with a small bicep arc. Universal "bodyweight / strength".
  flex:    <><path d="M5 14L13 8l5 7" /><path d="M7 12a4 3 0 014-3" /></>,
};
