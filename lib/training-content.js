...
export const STRENGTH_EXERCISES = [
  ...
  // ---- Kettlebell — a full-body MTB-specific KB block ----
  { id: "kb-2hand-swing",    name: "Two-hand KB swing",       workout: "Kettlebell",        sets: "5 × 15",       note: "Hinge from hips, snap to standing — power for climbs",  tags: ["glutes","hamstrings","power","kettlebell","hinge"] },
  { id: "kb-1hand-swing",    name: "Single-arm KB swing",     workout: "Kettlebell",        sets: "4 × 10/side",  note: "Resist rotation — anti-twist core under load",         tags: ["core","glutes","power","kettlebell","unilateral"] },
  { id: "kb-goblet-sq",      name: "KB goblet squat",         workout: "Kettlebell",        sets: "4 × 10",       note: "Bell at chest, elbows down — vertical torso",          tags: ["legs","quads","squat","kettlebell","beginner"] },
  { id: "kb-front-sq",       name: "KB front-rack squat",     workout: "Kettlebell",        sets: "4 × 6/side",   note: "Single KB in rack — core fires hard to stay tall",     tags: ["legs","core","squat","kettlebell","unilateral"] },
  { id: "kb-clean-press",    name: "KB clean & press",        workout: "Kettlebell",        sets: "5 × 5/side",   note: "Hips drive the bell; press finishes overhead",         tags: ["power","shoulders","kettlebell","explosive"] },
  { id: "kb-snatch",         name: "KB snatch",               workout: "Kettlebell",        sets: "5 × 5/side",   note: "Aggressive hip snap; punch through the handle",        tags: ["power","shoulders","kettlebell","advanced"] },
  { id: "kb-tgu",            name: "Turkish get-up",          workout: "Kettlebell",        sets: "3 × 3/side",   note: "Slow, deliberate — shoulder stability + full-body control", tags: ["stability","shoulders","core","kettlebell","advanced"] },
  { id: "kb-rev-lunge",      name: "KB goblet reverse lunge", workout: "Kettlebell",        sets: "3 × 8/leg",    note: "Step back, drop straight down — knee-friendly load",   tags: ["legs","quads","glutes","kettlebell","unilateral"] },
  { id: "kb-sl-dl",          name: "KB single-leg deadlift",  workout: "Kettlebell",        sets: "3 × 8/leg",    note: "Hinge over standing leg, hover off-leg behind",        tags: ["balance","hamstrings","glutes","kettlebell","unilateral"] },
  { id: "kb-halo",           name: "KB halo",                 workout: "Kettlebell",        sets: "3 × 6/direction", note: "Bell circles the head — opens shoulders, fires core", tags: ["shoulders","core","mobility","kettlebell"] },
  { id: "kb-windmill",       name: "KB windmill",             workout: "Kettlebell",        sets: "3 × 5/side",   note: "Eyes on overhead bell; hinge to touch the floor",      tags: ["mobility","shoulders","core","kettlebell","advanced"] },
  { id: "kb-renegade-row",   name: "KB renegade row",         workout: "Kettlebell",        sets: "3 × 8/side",   note: "Plank with row — anti-rotation while pulling",         tags: ["core","back","kettlebell","anti-rotation"] },
  { id: "kb-front-carry",    name: "KB front-rack carry",     workout: "Kettlebell",        sets: "3 × 40m",      note: "Bell in rack, slow controlled walk",                  tags: ["core","grip","kettlebell"] },

  // ---- Body Weight — no kit, anywhere, MTB-tuned ----
  { id: "bw-pushup",         name: "Push-up",                 workout: "Body Weight",       sets: "4 × 10–15",    note: "Shoulders away from ears, brace whole body",          tags: ["chest","triceps","shoulders","push","bodyweight","beginner"] },
  { id: "bw-pushup-decline", name: "Decline push-up",         workout: "Body Weight",       sets: "3 × 10",       note: "Feet on bench — more shoulder load",                  tags: ["shoulders","chest","push","bodyweight","intermediate"] },
  { id: "bw-pullup",         name: "Pull-up / Chin-up",       workout: "Body Weight",       sets: "4 × max",      note: "Bar work for the climbing pull — stop 1 rep short",   tags: ["back","biceps","pull","bodyweight"] },
  { id: "bw-inverted-row",   name: "Inverted row",            workout: "Body Weight",       sets: "4 × 10",       note: "Bar or table — chest to bar, body plank-straight",    tags: ["back","pull","bodyweight","beginner"] },
  { id: "bw-air-squat",      name: "Air squat",               workout: "Body Weight",       sets: "4 × 15",       note: "Sit between the heels, chest up — pause at bottom",   tags: ["legs","quads","glutes","squat","bodyweight","beginner"] },
  { id: "bw-jump-squat",     name: "Jump squat",              workout: "Body Weight",       sets: "4 × 8",        note: "Soft landings — explosive standover power",           tags: ["legs","plyo","power","bodyweight"] },
  { id: "bw-pistol",         name: "Pistol squat",            workout: "Body Weight",       sets: "3 × 5/leg",    note: "Counterweight arms or hold on something to start",    tags: ["legs","unilateral","balance","bodyweight","advanced"] },
  { id: "bw-rev-lunge",      name: "Reverse lunge",           workout: "Body Weight",       sets: "3 × 10/leg",   note: "Step back, drop straight — easier on knees",          tags: ["legs","quads","glutes","unilateral","bodyweight","beginner"] },
  { id: "bw-bulg-split",     name: "Bulgarian split squat",   workout: "Body Weight",       sets: "3 × 10/leg",   note: "Back foot on couch/chair — single-leg strength",      tags: ["legs","quads","glutes","unilateral","balance","bodyweight"] },
  { id: "bw-glute-bridge",   name: "Glute bridge",            workout: "Body Weight",       sets: "3 × 15",       note: "Drive through heels, squeeze at top — climb power",   tags: ["glutes","posterior","bodyweight","beginner"] },
  { id: "bw-sl-glute",       name: "Single-leg glute bridge", workout: "Body Weight",       sets: "3 × 12/leg",   note: "Off-leg lifted — isolates one side",                  tags: ["glutes","unilateral","bodyweight"] },
  { id: "bw-plank",          name: "Plank",                   workout: "Body Weight",       sets: "3 × 45 sec",   note: "Glutes squeezed, ribs down — no hip sag",             tags: ["core","plank","bodyweight","beginner"] },
  { id: "bw-side-plank",     name: "Side plank",              workout: "Body Weight",       sets: "3 × 30 sec/side", note: "Hips stacked, top arm overhead — anti-lateral core", tags: ["core","obliques","plank","bodyweight"] },
  { id: "bw-hollow",         name: "Hollow-body hold",        workout: "Body Weight",       sets: "3 × 30 sec",   note: "Low back glued to floor — full-body tension",         tags: ["core","gymnastics","bodyweight"] },
  { id: "bw-superman",       name: "Superman",                workout: "Body Weight",       sets: "3 × 10",       note: "Arms + legs lift together — wakes up posterior chain", tags: ["low-back","posterior","bodyweight"] },
  { id: "bw-bird-dog",       name: "Bird dog",                workout: "Body Weight",       sets: "3 × 10/side",  note: "Opposite arm + leg — anti-rotation, no hip drop",     tags: ["core","anti-rotation","bodyweight","beginner"] },
  { id: "bw-deadbug",        name: "Dead bug",                workout: "Body Weight",       sets: "3 × 10/side",  note: "Low back pressed down — anti-extension core",         tags: ["core","anti-extension","bodyweight"] },
  { id: "bw-mtn-climb",      name: "Mountain climber",        workout: "Body Weight",       sets: "3 × 30 sec",   note: "Knees to chest, hips low — conditioning + core",      tags: ["core","conditioning","bodyweight","cardio"] },
  { id: "bw-burpee",         name: "Burpee",                  workout: "Body Weight",       sets: "3 × 10",       note: "Full-body conditioning — the universal punisher",     tags: ["conditioning","bodyweight","cardio","full-body"] },
  { id: "bw-bear-crawl",     name: "Bear crawl",              workout: "Body Weight",       sets: "3 × 20m",      note: "Knees hover, shoulder-hip cross-pattern",             tags: ["core","shoulders","bodyweight","conditioning"] },
  { id: "bw-wall-sit",       name: "Wall sit",                workout: "Body Weight",       sets: "3 × 45 sec",   note: "Quads on fire — the descending-stance test",          tags: ["legs","quads","isometric","bodyweight"] },
];
