...
// Warm-minimal palette: gold / taupe / gray variations
export function sessionTagClass(type) {
  return ({
    ride:     "bg-[#f8df70]/20 text-[#f8df70] border border-[#f8df70]/60",
    strength: "bg-[#524b48]/60 text-[#e6e5e3] border border-[#a2a1a1]/40",
    yoga:     "bg-[#a2a1a1]/15 text-[#a2a1a1] border border-[#a2a1a1]/40",
    run:      "bg-[#c9a830]/20 text-[#f0d090] border border-[#c9a830]/50",
    rope:     "bg-[#7a6f4d]/40 text-[#d9c98c] border border-[#7a6f4d]/60",
    rest:     "bg-[#524b48]/40 text-[#a2a1a1] border border-[#524b48]/60",
  })[type] || "bg-[#524b48]/40 text-[#a2a1a1] border border-[#524b48]/60";
}
