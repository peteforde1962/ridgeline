...
export function sessionTagClass(type) {
  return ({
    ride:     "bg-orange-400/15 text-orange-300 border border-orange-400/40",
    strength: "bg-blue-400/15 text-blue-300 border border-blue-400/40",
    yoga:     "bg-green-400/15 text-green-300 border border-green-400/40",
    run:      "bg-amber-400/15 text-amber-300 border border-amber-400/40",
    rope:     "bg-red-400/15 text-red-300 border border-red-400/40",
    rest:     "bg-gray-500/15 text-gray-400 border border-gray-500/40",
  })[type] || "bg-gray-500/15 text-gray-400 border border-gray-500/40";
}
