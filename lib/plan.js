...
// Light palette tag colors: orange (ride) / teal (strength) / cream highlights
export function sessionTagClass(type) {
  return ({
    ride:     "bg-[#f26838]/15 text-[#c04018] border border-[#f26838]/50",
    strength: "bg-[#0f95b0]/15 text-[#0a6a7e] border border-[#0f95b0]/50",
    yoga:     "bg-[#4fa05f]/15 text-[#2f7240] border border-[#4fa05f]/50",
    run:      "bg-[#e0a040]/15 text-[#8e6420] border border-[#e0a040]/50",
    rope:     "bg-[#9b59b6]/15 text-[#6a3f80] border border-[#9b59b6]/50",
    rest:     "bg-[#6c7a82]/12 text-[#6c7a82] border border-[#6c7a82]/40",
  })[type] || "bg-[#6c7a82]/12 text-[#6c7a82] border border-[#6c7a82]/40";
}
