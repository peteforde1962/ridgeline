...
export function activityToRide(activity, userId) {
  // Sport types Strava uses for cycling
  const cyclingTypes = new Set([
    "Ride", "MountainBikeRide", "EBikeMountainBikeRide",
    "EBikeRide", "GravelRide", "Velomobile",
  ]);
  ...
  return {
    ...
    elev_ft: Math.round(activity.total_elevation_gain * 3.28084),
